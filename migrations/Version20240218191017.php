 ...
 */
final class Version20240218191017 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE coupons (id INT NOT NULL, code VARCHAR(5) NOT NULL, value NUMERIC(5, 2) NOT NULL, PRIMARY KEY(id))');
